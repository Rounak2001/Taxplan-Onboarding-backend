...
from consultant_assessment.models import TestType, UserSession, VideoResponse
from consultant_assessment.serializers import (
...
from consultant_assessment import gst as gst_module
from consultant_assessment import income_tax as income_tax_module
from consultant_assessment import tds as tds_module
from consultant_assessment import professional_tax as pt_module
from consultant_assessment import video_questions as video_questions_module
...
class UserSessionViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        # Failure = score <= 10 OR status == 'flagged'
    ...
    def submit_video(self, request, pk=None):
        ...
        try:
            ...
            from consultant_assessment.tasks import evaluate_video_task
    ...
    def process_proctoring_snapshot(self, request, pk=None):
        ...
        # Removed backend strict termination from here to let frontend handle separate limits
        if session.violation_count >= 10:
             session.status = 'flagged'
             session.save()
             return Response({'status': 'terminated', 'violation_count': session.violation_count}, status=status.HTTP_200_OK)
        ...
        try:
            ...
            # Rule 2: Face Match (if exactly 1 face)
                ...
                from consultant_assessment.models import FaceVerification
                try:
