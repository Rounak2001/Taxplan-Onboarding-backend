...
from .models import ConsultantCredential
...
def check_and_auto_generate_credentials(user):
    ...
    from .models import IdentityDocument, ConsultantDocument
    ...
    # These models will be in consultant_assessment later, importing them directly
    # Note: Ensure this works when assessment models are migrated!
    try:
        from consultant_assessment.models import UserSession, VideoResponse
    except ImportError:
        # Fallback to old app name during transition
