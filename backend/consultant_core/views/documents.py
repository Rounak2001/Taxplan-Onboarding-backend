...
from consultant_core.models import ConsultantDocument
from consultant_core.serializers import ConsultantDocumentSerializer
import os
import time
...
class UploadDocumentView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            # Verify with Gemini
            try:
                from consultant_assessment.services import QualificationDocumentVerifier
            except ImportError:
