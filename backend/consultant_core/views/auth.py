...
from consultant_core.models import User, IdentityDocument, ConsultantDocument as RealConsultantDocument
from consultant_core.serializers import UserSerializer, GoogleAuthSerializer, OnboardingSerializer, AuthConsultantDocumentSerializer
from consultant_core.authentication import generate_jwt_token
...
def get_user_profile(request):
    ...
    try:
        # Handling the transition phase where assessment models might be in assessment or consultant_assessment
        try:
            from consultant_assessment.models import UserSession
        except ImportError:
...
def upload_identity_document(request):
    ...
    try:
        ...
        # Verify with Gemini
        # Support both new and old app paths during migration
        try:
            from consultant_assessment.services import IdentityDocumentVerifier
        except ImportError:
